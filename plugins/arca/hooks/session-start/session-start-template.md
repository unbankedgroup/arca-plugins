...
Run this bash every session start to drop its OOM priority:
...
Silent if no plugin processes found (normal on first boot before plugin spawns — heartbeat step 9C also runs this).
